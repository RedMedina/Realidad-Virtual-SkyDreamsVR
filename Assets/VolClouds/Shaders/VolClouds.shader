...
Shader "LemonSpawn/VolumetricClouds" {
	...
	Properties{
		...
		_CloudDistance("Distance", Range(-2,0.25)) = 0.03
		...
		Pass
	{
		...
		fixed4 frag(v2f IN) : COLOR{
			...
			if (v3CameraPos.y<h.x+500) { // Below camera height
